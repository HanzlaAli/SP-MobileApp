...
class TermToUseScreen extends StatelessWidget {
              ...
              Center(
                child: Column(
                  children: [
                    ...
                    Paragraph(
                        text:
                            "Welcome to Mended Solutions’s online Platform. Please read these Terms of Use carefully, as they govern your use of our Website, Application, Products, and Services."),
                    verticalSpacing10,
                    Headings(
                      text:
                          "IF YOU HAVE A MEDICAL EMERGENCY, IMMEDIATELY CALL YOURPRIMARY CARE PROVIDER OR DIAL 911. Mended Solutions’S SERVICES ARENOT APPROPRIATE FOR EMERGENCY MEDICAL CONCERNS.",
                      fontsize: 17,
                    ),
                  ],
                ),
  ...
  Widget acceptenceOfTermOfUse() => Column(
        ...
        children: [
          ...
          Paragraph(
              text:
                  "These terms of use are entered into by and between You and Mended Solutions (Mended Solutions“, the”Company,\" “we ”our,\" or “us”). The following terms and conditions, together with any documents they expressly incorporate by reference (collectively, “Terms of Use”), govern your access to and use of the Mended Solutions online Platform through which healthcare services may be provided, including any content, functionality, and services offered on or through the Mended Solutions Mobile Application or the Mended Solutions Website (collectively the “Platform”), whether as a guest or a registered user. This Mended Solutions Platform is owned and operated by Mended Solutions Website located in Florida, United States (info@Mended Solutions.com). The Platform may be provided or be accessible via multiple websites or applications whether owned or operated by us or by third parties, including, without limitation, the website Mended Solutions Website and its related apps. "),
          verticalSpacing10,
          Paragraph(
              text:
          ...
          Paragraph(
              text:
                  "This Platform is offered and available to users who are 18 years of age or older and reside in the United States or any of its territories or possessions. By using this Platform, you represent and warrant that you are of legal age to form a binding contract with Mended Solutions and meet all of the foregoing eligibility requirements. If you do not meet all of these requirements, you must not access or use the Platform."),
          verticalSpacing10,
          Paragraph(
              text:
  ...
  Widget providers_healthCareServices() => Column(
        ...
        children: [
          ...
          Headings(
            text:
                "DO NOT DISREGARD, AVOID, OR DELAY IN OBTAINING IN-PERSON CARE FROM YOUR SERVICE PROVIDER OR OTHER QUALIFIED PROFESSIONAL BECAUSE OF INFORMATION OR ADVICE YOU RECEIVED THROUGH THE PLATFORM.",
            fontsize: 14,
          ),
        ],
      );
  ...
  Widget paymentAndFees() => Column(
        ...
        children: [
          ...
          Paragraph(
              text:
                  "By selecting a Healthcare Service from a Provider, you acknowledge that such Service include a 5% fee that goes to Mended Solutions."),
          verticalSpacing12,
          Headings(
            text: "Provider Fees",
            fontsize: 15,
          ...
          Paragraph(
              text:
                  "By accepting a request for Healthcare Service from a User, you acknowledge that Mended Solutions charges a 5% fee."),
          verticalSpacing12,
          Headings(
            text: "Payment",
            fontsize: 15,
  ...
  Widget intellectualPropertyRights() => Column(
        ...
        children: [
          ...
          Paragraph(
              text:
                  "The Platform and its entire contents, features, and functionality (including but not limited to all information, software, text, displays, images, video, and audio, and the design, selection, and arrangement thereof) are owned by Mended Solutions, its licensors, or other providers of such material and are protected by United States and international copyright, trademark, patent, trade secret, and other intellectual property or proprietary rights laws."),
          verticalSpacing10,
          Paragraph(
              text:
          ...
          Paragraph(
              text:
                  "If you wish to make any use of material on the Platform other than that set out in this section, please address your request to the following email: info@Mended Solutions.com."),
          verticalSpacing10,
          Paragraph(
              text:
                  "If you print, copy, modify, download, or otherwise use or provide any other person with access to any part of the Platform in breach of the Terms of Use, your right to use the Platform will stop immediately and you must, at our option, return or destroy any copies of the materials you have made. No right, title, or interest in or to the Platform or any content on the Platform is transferred to you, and all rights not expressly granted are reserved by Mended Solutions. Any use of the Platform not expressly permitted by these Terms of Use is a breach of these Terms of Use and may violate copyright, trademark, and other laws."),
        ],
      );
  ...
  Widget trademarks() => Column(
        ...
        children: [
          ...
          Paragraph(
              text:
                  "The Company name, the term Mended Solutions, and all related names, logos, product and service names, designs, and slogans are trademarks of Mended Solutions or its affiliates or licensors. You must not use such marks without the prior written permission of Mended Solutions. All other names, logos, product and service names, designs, and slogans on this Platform are the trademarks of their respective owners."),
        ],
      );
  ...
  Widget privacyAndSecurity() => Column(
        ...
        children: [
          ...
          Paragraph(
              text:
                  "Protecting and safeguarding any information you provide through the Platform is extremely important to us. Information about our security and privacy practices can be found on our Privacy Policy, available at Mended Solutions.com/legal/privacy-policy. "),
          verticalSpacing10,
          Headings(
            text:
  ...
  Widget prohibitedUsers() => Column(
        ...
        children: [
          ...
          UnorderList(
              "To impersonate or attempt to impersonate Mended Solutions, a Company employee, another user, or any other person or entity (including, without limitation, by using email addresses or screen names associated with any of the foregoing)."),
          UnorderList(
              "To engage in any other conduct that restricts or inhibits anyone’s use or enjoyment of the Platform, or which, as determined by us, may harm Mended Solutions or users of the Platform, or expose them to liability."),
          verticalSpacing10,
  ...
  Widget userContributions() => Column(
        ...
        children: [
          ...
          Paragraph(
              text:
                  "You understand and acknowledge that you are responsible for any User Contributions you submit or contribute, and you, not Mended Solutions, have full responsibility for such content, including its legality, reliability, accuracy, and appropriateness."),
          verticalSpacing10,
          Paragraph(
              text:
  ...
  Widget monitoring_Enforcement_Termination() => Column(
        ...
        children: [
          ...
          Paragraph(
              text:
                  "Without limiting the foregoing, we have the right to cooperate fully with any law enforcement authorities or court order requesting or directing us to disclose the identity or other information of anyone posting any materials on or through the Platform. YOU WAIVE AND HOLD HARMLESS Mended Solutions AND ITS AFFILIATES, LICENSEES, AND SERVICE PROVIDERS FROM ANY CLAIMS RESULTING FROM ANY ACTION TAKEN BY ANY OF THE FOREGOING PARTIES DURING, OR TAKEN AS A CONSEQUENCE OF, INVESTIGATIONS BY EITHER SUCH PARTIES OR LAW ENFORCEMENT AUTHORITIES."),
          verticalSpacing10,
          Paragraph(
              text:
  ...
  Widget contentStandards() => Column(
        ...
        children: [
          ...
          UnorderList(
              "Violate the legal rights (including the rights of publicity and privacy) of others or contain any material that could give rise to any civil or criminal liability under applicable laws or regulations or that otherwise may be in conflict with these Terms of Use and our Privacy Policy, available at https://Mended Solutions.com/legal/privacy-policy."),
  ...
  Widget copyrightInfringement() => Column(
        ...
        children: [
          ...
          Paragraph(
              text:
                  "If you believe that any User Contributions violate your copyright, please see our Copyright DMCA Policy, available at Mended Solutions.com/legal/copyright-dmca-policy for instructions on sending us a notice of copyright infringement. It is the policy of Mended Solutions to terminate the user accounts of repeat infringers."),
        ],
      );
  ...
  Widget relianceOnInformationPosted() => Column(
        ...
        children: [
          ...
          Paragraph(
              text:
                  "This Platform may include content provided by third parties, including materials provided by other users, bloggers, and third-party licensors, syndicators, aggregators, and/or reporting services. All statements and/or opinions expressed in these materials, and all articles and responses to questions and other content, other than the content provided by Mended Solutions, are solely the opinions and the responsibility of the person or entity providing those materials. These materials do not necessarily reflect the opinion of Mended Solutions. We are not responsible, or liable to you or any third party, for the content or accuracy of any materials provided by any third parties")
        ],
      );
  ...
  Widget InfoAboutYou_yourVisitToPlatform() => Column(
        ...
        children: [
          ...
          Paragraph(
              text:
                  "All information we collect on this Platform is subject to our Privacy Policy, available at Mended Solutions.com/legal/privacy-policy. By using the Platform, you consent to all actions taken by us with respect to your information in compliance with the Privacy Policy."),
        ],
      );
  ...
  Widget disclaimerOfWarranties() => Column(
        ...
        children: [
          ...
          Paragraph(
              text:
                  "YOUR USE OF THE PLATFORM, ITS CONTENT, AND ANY SERVICES OR ITEMS OBTAINED THROUGH THE PLATFORM IS AT YOUR OWN RISK. THE PLATFORM, ITS CONTENT, AND ANY SERVICES OR ITEMS OBTAINED THROUGH THE PLATFORM ARE PROVIDED ON AN “AS IS” AND “AS AVAILABLE” BASIS, WITHOUT ANY WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED. TO THE FULLEST EXTENT PROVIDED BY LAW, Mended Solutions HEREBY DISCLAIMS ALL WARRANTIES OF ANY KIND, WHETHER EXPRESS OR IMPLIED, STATUTORY, OR OTHERWISE, INCLUDING BUT NOT LIMITED TO ANY WARRANTIES OF MERCHANTABILITY, NON-INFRINGEMENT, SECURITY, ACCURACY, TITLE, AND FITNESS FOR PARTICULAR PURPOSE. NEITHER Mended Solutions NOR ANY PERSON ASSOCIATED WITH Mended Solutions MAKES ANY WARRANTY OR REPRESENTATION WITH RESPECT TO THE COMPLETENESS, SECURITY, RELIABILITY, QUALITY, ACCURACY, OR AVAILABILITY OF THE PLATFORM. WITHOUT LIMITING THE FOREGOING, NEITHER Mended Solutions NOR ANYONE ASSOCIATED WITH Mended Solutions REPRESENTS OR WARRANTS THAT THE PLATFORM, ITS CONTENT, OR ANY SERVICES OR ITEMS OBTAINED THROUGH THE PLATFORM WILL BE ACCURATE, RELIABLE, ERROR-FREE, OR UNINTERRUPTED, THAT DEFECTS WILL BE CORRECTED, THAT OUR PLATFORM OR THE SERVER THAT MAKES IT AVAILABLE ARE FREE OF VIRUSES OR OTHER HARMFUL COMPONENTS, OR THAT THE PLATFORM OR ANY SERVICES OR ITEMS OBTAINED THROUGH THE PLATFORM WILL OTHERWISE MEET YOUR NEEDS OR EXPECTATIONS"),
          verticalSpacing10,
          Paragraph(
              text:
  ...
  Widget waiver_Severability() => Column(
        ...
        children: [
          ...
          Paragraph(
              text:
                  "No waiver by Mended Solutions of any term or condition set out in these Terms of Use shall be deemed a further or continuing waiver of such term or condition or a waiver of any other term or condition, and any failure of Mended Solutions to assert a right or provision under these Terms of Use shall not constitute a waiver of such right or provision."),
          verticalSpacing10,
          Paragraph(
              text:
  ...
  Widget headings_EntireAgreement_Notices_YouCommentsAndConcerns() => Column(
        ...
        children: [
          ...
          Paragraph(
              text:
                  "The Terms of Use, our Privacy Policy, and our Copyright DMCA Policy constitute the sole and entire agreement between you and Mended Solutions regarding the Platform and supersede all prior and contemporaneous understandings, agreements, representations, and warranties, both written and oral, regarding the Platform."),
          verticalSpacing16,
          Headings(text: "NOTICES"),
          verticalSpacing12,
          Paragraph(
              text:
                  "We may provide notices or other communications to you regarding this agreement or any aspect of the Platform, by email to the email address that we have on record, by regular mail or by posting it online. The date of receipt shall be deemed the date  on which such notice is given. Notices sent to us must be delivered by email to info@Mended Solutions.com."),
          verticalSpacing10,
          Headings(
          ...
          Paragraph(
              text:
                  "This Platform is operated by Mended Solutions, a limited liability company registered in Florida."),
          verticalSpacing10,
          Paragraph(
              text:
                  "All notices of copyright infringement claims should be sent to the copyright agent designated in our Copyright DMCA Policy, available at Mended Solutions.com/legal/copyright-dmca-policy in the manner and by the means set out therein."),
          verticalSpacing10,
          Paragraph(
              text:
                  "All other feedback, comments, requests for technical support, and other communications relating to the Platform should be directed to the following email address: info@Mended Solutions.com."),
        ],
      );
}
