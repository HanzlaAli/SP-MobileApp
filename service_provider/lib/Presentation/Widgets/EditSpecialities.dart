...
class EditServiceProviderSpecialities extends StatefulWidget {
  EditServiceProviderSpecialities({super.key, required this.model});
  List<Specializations> model;

  @override
  State<EditServiceProviderSpecialities> createState() => _EditServiceProviderSpecialitiesState();
}

class _EditServiceProviderSpecialitiesState extends State<EditServiceProviderSpecialities> {
                            ...
                            child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  var isTrue = widget.model.any((element) =>
                                      state
                                          .getSpecializationModel[index].name ==
                                      element.name);
                                  return Specialities(
                                    text: state.getSpecializationModel[index]
                                            .name ??
                                        "",
