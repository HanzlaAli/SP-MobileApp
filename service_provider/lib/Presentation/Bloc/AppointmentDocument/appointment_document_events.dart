...
class CreateAppointmentDocumentsEvent extends AppointmentDocumentEvent {
  CreateAppointmentDocumentsModel model;
  CreateAppointmentDocumentsEvent({required this.model});
}
